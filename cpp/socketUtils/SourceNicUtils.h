 ...
 */
#define VERIFY(CONDITION, MESSAGE, LOGG) \
     if (!(CONDITION)) { \
         SourceNicUtils::verify_error(MESSAGE, #CONDITION, __FILE__, __LINE__, 0, LOGG); \
     }
 ...
 */
#define VERIFY_ERR(CONDITION, MESSAGE, LOGG) \
     if (!(CONDITION)) { \
         SourceNicUtils::verify_error(MESSAGE, #CONDITION, __FILE__, __LINE__, errno, LOGG); \
     }
